...
public class RoycePathFinding : PathFind
{
    ...
    protected override void LocationReached()
    {
        switch (routineIndex)
        {
            ...
            case 0:
                ...
                {
                    case 2:
                        NextLocation(12, 00, reverse);
                        break;
                    case 10:
                        NextLocation(14, 10, reverse);
                        break;
                    case 18:
                        NextLocation(16, 21, reverse);
                        break;
                    case 23:
                        NextLocation(19, 03, reverse);
                        break;
                    case 19:
                        print("Royce termina rutina 1");
                        startRoutine = false;
                        break;
                    default:
                        waitMinutes = false;
